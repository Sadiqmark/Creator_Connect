...
import { Sparkles, LogOut, Camera, Inbox } from 'lucide-react';
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-foreground-secondary mt-1">
                Authenticated with role: <span className="font-bold text-foreground">CREATOR</span> | Account: <span className="font-bold text-emerald-600">ACTIVE</span>
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-border">
            <div className="p-5 rounded-xl bg-background border border-border">
              ...
              <p className="text-xs text-foreground-secondary mt-1">
                Authentication and email verification gates active.
              </p>
            </div>

            <div className="p-5 rounded-xl bg-background border border-border">
              <div className="text-foreground font-semibold text-sm">
                Private Collaboration Contact
              </div>
              <p className="mt-2 text-sm font-medium text-foreground-secondary">
                Protected at API layer (only exposed upon confirmed inquiry acceptance).
              </p>
            </div>
          </div>
        </div>
